...
print("Setpoint temp max: " + str(unit.get_setpoint_temp_max))
print("Setpoint temp min: " + str(unit.get_setpoint_temp_min))
...
print("Current humidity:" + str(unit.get_current_humidity))
print("Setpoint humidity:" + str(unit.get_setpoint_humidity))
print("REG_SENSOR_OAT: " + str(unit.get_raw_holding_register('REG_SENSOR_OAT')))
